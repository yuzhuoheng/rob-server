...
@router.post("/", response_model=schemas.GameInDB)
...
@router.get("/", response_model=List[schemas.GameInDB])
...
@router.get("/{game_id}", response_model=schemas.GameInDB)
...
@router.put("/{game_id}", response_model=schemas.GameInDB)
